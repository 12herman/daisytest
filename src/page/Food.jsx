        ...
        FoodPageProductData.map((fdata,i)=>(
          ...
          <figure className='relative'>
            <img
              ...
              <span className={`${!fdata.isweightproduct ? 'hidden' : 'block'} absolute bottom-2 right-2 bg-primary text-white font-semibold px-2 py-1 rounded-lg text-xs`}>{fdata.weight}</span>
          </figure>
